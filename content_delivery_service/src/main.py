...
from core.config import app_settings, elasticsearch_settings, jaeger_settings, redis_settings
...
app.include_router(films.router, prefix="/api/v1/films", tags=["films"], dependencies=[Depends(security_jwt)])
app.include_router(genres.router, prefix="/api/v1/genres", tags=["genres"], dependencies=[Depends(security_jwt)])
app.include_router(persons.router, prefix="/api/v1/persons", tags=["persons"], dependencies=[Depends(security_jwt)])
